...
declare and assign all these variables:
    ...
    public static void main(String[] args) {
        int grade1 = 20, grade2 = 25, grade3 = 34, grade4 = 28, grade5 = 23;
        int total = grade1 + grade2 + grade3+ grade4 + grade5;
        double averageGpa = 3.8, numberOfSchoolDays = 110.5, numberSnowDays = 3.5;
        System.out.println(total);
        System.out.println(averageGpa);
        System.out.println("numberOfSchoolDays = " + numberOfSchoolDays);
        System.out.println("numberSnowDays = " + numberSnowDays);
